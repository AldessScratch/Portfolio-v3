...
export default function ProjectCard(props: ProjectCardProps) {
  ...
  return (
    <div ref={galleryRef} className="card rounded-2xl border-1 backdrop-blur-lg shadow-lg text-black bg-transparent dark:text-white dark:border-gray-700 border-transparent h-[430px] sm:h-[380px] transform transition-all duration-300 hover:border-gray-900 dark:hover:border-white hover:scale-103">
